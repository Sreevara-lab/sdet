REM   Script: Activity 10 - Session 02
REM   Activity 10 - Session 02

Select * from dual;

Select sysdate from dual;

Select upper('THIS IS ALREADY UPPER')  from dual;
...
SELECT a.customer_name AS "Customer Name", a.city, SALESMAN_NAME.name AS "Salesman", b.commission FROM customers a  
INNER JOIN salesman b ON a.salesman_id=b.salesman_id;
